...
!!! abstract "Exercise"
    <mark>See the following Excel sheet that implements a distance-weighted voting $k$NN algorithm.</mark> Try adjusting the values in the dataset (in the sheet) to see the effect on the algorithm’s different steps.

    - Download exercise (.xlsx): <https://minerva.leeds.ac.uk/bbcswebdav/xid-18754875_4" download>Iris k-NN prediction</a>
