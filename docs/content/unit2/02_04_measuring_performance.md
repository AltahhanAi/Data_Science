...
Let us now see how these metrics react to an increase in one of the classes, i.e. when the problem has imbalanced classes issue.x
...
$$
\begin{array}{cc}
\text { Detect }_{+}=\frac{50}{50+50}=0.5 \mid \text { Detect }_{-}=\frac{990}{990+10}=0.99 \\
