...
In the next few lessons we cover common classification techniques. Namely we will cover decision trees, K-nearest neighbours and linear models. These are among the simplest, widely used and effective techniques. We will also see their strengths and limitations and when they are most suitable for which type of problems. We will demonstrate important concepts alongside the techniques such as applying data preparation and performance measure.
