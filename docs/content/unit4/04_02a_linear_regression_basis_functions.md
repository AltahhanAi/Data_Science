...
We still call $w_0$ the bias or the intercept. <mark>Note that given an input space with one input $x_1$ our linear model can be defined as</mark>

However, the following are all **linear models**:

- <mark>$y(\mathbf{x}, \mathbf{w})=w_{0}+w_{1} x_{1}^{2}+w_{2} x_{2}^{2}+\cdots+w_{D} x_{D}^{2}$</mark>
- <mark>$y(\mathbf{x}, \mathbf{w})=w_{0}+w_{1} x_{1}^{1}+w_{2} x_{2}^{2}+\cdots+w_{D} x_{D}^{D}$</mark>
- <mark>$y(\mathbf{x}, \mathbf{w})=w_{0}+w_{1} e^{x_{1}}+w_{2} e^{x_{2}}+\cdots+w_{D} e^{x_{D}}$</mark>
- <mark>$y(\mathbf{x}, \mathbf{w})=w_{0}+w_{1} e^{x_{1}}+w_{2} e^{x_{2}}+w_{3} e^{x_{1}+x_{2}}+w_{3} e^{x_{1}-x_{2}}$</mark>
...
<mark>$y(\mathbf{x}, \mathbf{w})=w_{0}+w_{1} \phi_{1}(\mathbf{x})+w_{2} \phi_{2}(\mathbf{x})+\cdots+w_{M} \phi_{M}(\mathbf{x})$</mark>

<mark>$y(\mathbf{x}, \mathbf{w})=w_{0}+\sum_{m=1}^{M} w_{m} \phi_{m}(\mathbf{x})$</mark>
...
(10)<mark>$y(\mathbf{x}, \mathbf{w})=w_{0}+\mathbf{w}^{\top} \boldsymbol{\phi}$</mark>
...
(11) <mark>$y(\mathbf{x}, \mathbf{w})=\mathbf{w}^{\top} \boldsymbol{\phi}$</mark>
